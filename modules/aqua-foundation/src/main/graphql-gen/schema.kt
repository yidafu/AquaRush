...
enum class DailyCollectionStatus(
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): DailyCollectionStatus? = values().find { it.label == label }
  }
}
...
enum class DailyReconciliationStatus(
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): DailyReconciliationStatus? = values().find { it.label == label }
  }
}
...
enum class OperatorType(
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): OperatorType? = values().find { it.label == label }
  }
}
...
enum class OrderOperationType(
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): OrderOperationType? = values().find { it.label == label }
  }
}
