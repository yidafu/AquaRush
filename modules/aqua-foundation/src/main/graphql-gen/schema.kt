...
enum class AdminRole(val label: String) {
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): AdminRole? {
...
data class BatchImportAddressesResult(
...
data class BucketDepositVoPage(
...
data class ConfirmDailyCollectionInput(
    val notes: kotlin.String? = null,
    val recordId: kotlin.Long
) {
  constructor(args: Map<String, Any>) : this(
      args["notes"] as kotlin.String?,
      args["recordId"] as kotlin.Long
  )
}
...
data class CreateDeliveryOrderInput(
    @field:Positive(message = "地址ID必须为正数")
    val addressId: kotlin.Long,
    val isSelfCollect: kotlin.Boolean? = false,
  ...
  constructor(args: Map<String, Any>) : this(
      ...
      args["isSelfCollect"] as kotlin.Boolean? ?: false,
      args["productId"] as kotlin.Long,
      args["quantity"] as kotlin.Int,
...
data class DailyCollectionRecord(
    val calculatedCashAmountCents: kotlin.Long,
    val calculatedOrderAmountCents: kotlin.Long,
    val calculatedQrCodeAmountCents: kotlin.Long,
    val calculatedWaterTicketCount: kotlin.Int,
    val cashAmountCents: kotlin.Long,
    val collectionDate: kotlin.String,
    val confirmedAt: java.time.LocalDateTime?,
    val confirmedBy: kotlin.Long?,
    val createdAt: java.time.LocalDateTime,
    val deliveryWorkerId: kotlin.Long,
    val differenceAmountCents: kotlin.Long,
    val id: kotlin.Long,
    val notes: kotlin.String?,
    val orderAmountCents: kotlin.Long,
    val orderCount: kotlin.Int,
    val qrCodeAmountCents: kotlin.Long,
    val status: DailyCollectionStatus,
    val updatedAt: java.time.LocalDateTime,
    val waterTicketCount: kotlin.Int
)

enum class DailyCollectionStatus(val label: String) {
      CONFIRMED("CONFIRMED"),
      DISPUTED("DISPUTED"),
      DRAFT("DRAFT"),
      SUBMITTED("SUBMITTED");
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): DailyCollectionStatus? {
      return values().find { it.label == label }
    }
  }
}
...
data class DailyReconciliation(
    val createdAt: java.time.LocalDateTime,
    val discrepancyAmountCents: kotlin.Long,
    val id: kotlin.Long,
    val reconciliationDate: kotlin.String,
    val reportData: tools.jackson.databind.node.ObjectNode?,
    val reviewNotes: kotlin.String?,
    val reviewedAt: java.time.LocalDateTime?,
    val reviewedBy: kotlin.Long?,
    val status: DailyReconciliationStatus,
    val totalCashAmountCents: kotlin.Long,
    val totalCollectionAmountCents: kotlin.Long,
    val totalOrderAmountCents: kotlin.Long,
    val totalOrderCount: kotlin.Int,
    val totalQrCodeAmountCents: kotlin.Long,
    val totalWaterTicketCount: kotlin.Int,
    val updatedAt: java.time.LocalDateTime
)

enum class DailyReconciliationStatus(val label: String) {
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): DailyReconciliationStatus? {
      return values().find { it.label == label }
    }
  }
}
...
data class DailyStatistic(
    val date: kotlin.String,
    val orderCount: kotlin.Int,
    val orderProductCount: kotlin.Int,
    val revenue: kotlin.Float
)
...
data class DeliveryWorker(
    ...
    val currentTaskCount: kotlin.Int,
    val earning: kotlin.Long?,
    val id: kotlin.Long,
...
data class DeliveryWorkerOverview(
    val deliveringOrders: kotlin.Int,
    val todayActiveWorkers: kotlin.Int,
    val todayCompletedOrders: kotlin.Int,
    val totalWorkers: kotlin.Int
)
...
data class FavoriteProductVoPage(
...
data class LoginStatistics(
    val dailyLogins: Iterable<DailyLoginStatistic>,
    val todayLogins: kotlin.Int,
    val totalLogins: kotlin.Int
)
...
data class MessageHistoryVoPage(
...
data class MutationBatchImportAddressesArgs(
    val input: Iterable<AddressInput>
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      args["input"]!!.let { input -> (input as List<Map<String, Any>>).map { AddressInput(it) } }
  )
}
...
data class MutationConfirmDailyCollectionArgs(
    val input: ConfirmDailyCollectionInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      ConfirmDailyCollectionInput(args["input"] as Map<String, Any>)
  )
}
...
data class MutationCreateAdminAddressArgs(
    val input: AddressInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
...
data class MutationCreateDeliveryOrderArgs(
    val input: CreateDeliveryOrderInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      CreateDeliveryOrderInput(args["input"] as Map<String, Any>)
  )
}
...
data class MutationDeleteAdminAddressArgs(
    val id: kotlin.Long
) {
  constructor(args: Map<String, Any>) : this(
      args["id"] as kotlin.Long
...
data class MutationExecuteDailyReconciliationArgs(
    val reconciliationDate: kotlin.String? = null
) {
  constructor(args: Map<String, Any>) : this(
      args["reconciliationDate"] as kotlin.String?
  )
}
...
data class MutationReviewReconciliationArgs(
    val input: ReviewReconciliationInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      ReviewReconciliationInput(args["input"] as Map<String, Any>)
  )
}
...
data class MutationSubmitDailyCollectionArgs(
    val input: SubmitDailyCollectionInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      SubmitDailyCollectionInput(args["input"] as Map<String, Any>)
  )
}
...
data class Mutation(
    val acceptDelivery: Order,
    val assignDeliveryWorker: Order,
    ...
    val deleteAdminAddress: kotlin.Boolean,
    ...
    val executeDailyReconciliation: DailyReconciliation,
    ...
    val reviewReconciliation: DailyReconciliation,
    val setDefaultAddress: kotlin.Boolean,
    val startDelivery: Order,
    val submitDailyCollection: DailyCollectionRecord,
...
data class MyTodayCollectionVo(
    val calculatedCashAmountCents: kotlin.Long?,
    val calculatedOrderAmountCents: kotlin.Long?,
    val calculatedQrCodeAmountCents: kotlin.Long?,
    val calculatedWaterTicketCount: kotlin.Int?,
...
enum class OperatorType(val label: String) {
      ADMIN("ADMIN"),
      DELIVERY_WORKER("DELIVERY_WORKER"),
      SYSTEM("SYSTEM"),
      USER("USER");
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): OperatorType? {
      return values().find { it.label == label }
    }
  }
}
...
data class Order(
    ...
    val createdAt: java.time.LocalDateTime,
    val deliveryConfirmedAt: java.time.LocalDateTime?,
    val deliveryPhotos: Iterable<kotlin.String>?,
    val deliveryStartedAt: java.time.LocalDateTime?,
    val deliveryWorker: DeliveryWorker?,
    val id: kotlin.Long,
    val isSelfCollect: kotlin.Boolean,
    val orderNo: kotlin.String,
...
data class OrderOperation(
    val createdAt: java.time.LocalDateTime,
    val description: kotlin.String?,
    val extraData: tools.jackson.databind.node.ObjectNode?,
    val id: kotlin.Long,
    val operationType: OrderOperationType,
    val operatorId: kotlin.Long?,
    val operatorType: OperatorType?,
    val orderId: kotlin.Long
)

enum class OrderOperationType(val label: String) {
  ...
  companion object {
    @JvmStatic
    fun valueOfLabel(label: String): OrderOperationType? {
      return values().find { it.label == label }
    }
  }
}
...
data class OrderVoPage(
    val content: Iterable<Order>,
...
data class ProductFavoriteStat(
    val favoriteCount: kotlin.Long,
    val productId: kotlin.Long,
    val productName: kotlin.String
)

data class ProductFavoriteVoPage(
...
data class ProductSalesTrend(
    val dailySales: Iterable<ProductDailySales>,
    val productId: kotlin.Long?,
    val productName: kotlin.String?
)

data class ProductSalesTrendInput(
    val endDate: java.time.LocalDateTime,
    val productId: kotlin.Long? = null,
    val startDate: java.time.LocalDateTime
) {
...
data class ProductStatistics(
    ...
    val favoriteStatistics: Iterable<ProductFavoriteStat>,
    val lowStockProducts: kotlin.Int,
    val offlineProducts: kotlin.Int,
    val onlineProducts: kotlin.Int,
    val productRanking: Iterable<ProductSalesStat>,
    val totalFavorites: kotlin.Int,
...
data class QueryDailyCollectionsArgs(
    val collectionDate: kotlin.String? = null
) {
  constructor(args: Map<String, Any>) : this(
      args["collectionDate"] as kotlin.String?
  )
}
data class QueryDailyReconciliationArgs(
    val reconciliationDate: kotlin.String
) {
  constructor(args: Map<String, Any>) : this(
      args["reconciliationDate"] as kotlin.String
...
data class QueryDeliveryWorkerHistoryOrdersArgs(
    val keyword: kotlin.String? = null,
    val page: kotlin.Int? = 0,
    val size: kotlin.Int? = 20,
    val status: OrderStatus? = null
...
data class QueryOrderByNoArgs(
    val orderNo: kotlin.String
) {
  constructor(args: Map<String, Any>) : this(
      args["orderNo"] as kotlin.String
  )
}
data class QueryOrderOperationsArgs(
    val orderId: kotlin.Long
) {
  constructor(args: Map<String, Any>) : this(
      args["orderId"] as kotlin.Long
...
data class QueryOrdersArgs(
    val input: OrderListInput? = null
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      args["input"]?.let { OrderListInput(it as Map<String, Any>) }
  )
}
...
data class QueryProductDailySalesArgs(
    val input: DateRangeInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
...
data class QueryProductSalesTrendArgs(
    val input: ProductSalesTrendInput
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      ProductSalesTrendInput(args["input"] as Map<String, Any>)
  )
}
...
data class QueryProductsPaginatedArgs(
    val input: ProductSearchInput? = null
) {
  @Suppress("UNCHECKED_CAST")
  constructor(args: Map<String, Any>) : this(
      args["input"]?.let { ProductSearchInput(it as Map<String, Any>) }
  )
}
...
data class QuerySearchAllAddressesArgs(
    val keyword: kotlin.String? = null,
    val page: kotlin.Int? = 0,
    val size: kotlin.Int? = 10
) {
  constructor(args: Map<String, Any>) : this(
      args["keyword"] as kotlin.String?,
      args["page"] as kotlin.Int? ?: 0,
      args["size"] as kotlin.Int? ?: 10
  )
}
...
data class QuerySearchUserAddressesArgs(
    val keyword: kotlin.String,
    val page: kotlin.Int? = 0,
    val size: kotlin.Int? = 10,
    val userId: kotlin.Long? = null
...
data class Query(
    val activeProducts: ProductVoPage,
    val address: Address?,
    val addresses: Iterable<Address>,
    val admin: Admin?,
    val admins: Iterable<Admin>,
    val allProducts: Iterable<Product>,
    val allProductsFavoriteStats: AllProductsFavoriteStats,
    val allRegions: Iterable<Region>,
    val assignedOrders: Iterable<Order>,
    val calculateDistance: DistancePayload?,
    val checkOrderReview: OrderReviewCheckResponse,
    val dailyCollections: Iterable<DailyCollectionRecord>,
    val dailyReconciliation: DailyReconciliation?,
    val dailyReconciliations: Iterable<DailyReconciliation>,
    val dailyStatistics: Iterable<DailyStatistic>,
    val defaultRegionHierarchy: RegionHierarchy?,
    val deliveringOrders: Iterable<Order>,
    val deliveryAddress: DeliveryAddress?,
    val deliveryAddresses: Iterable<DeliveryAddress>,
    val deliveryWorker: DeliveryWorker?,
    val deliveryWorkerHistoryOrders: OrderVoPage,
    val deliveryWorkerRanking: Iterable<DeliveryWorkerRankingItem>,
    val deliveryWorkerStatistics: DeliveryWorkerOverview,
    val deliveryWorkers: Iterable<DeliveryWorker>,
    val favoriteProducts: FavoriteProductVoPage,
    val favoritesCount: kotlin.Long,
    val findUserByPhone: User?,
    val findUsersByAddress: Iterable<User>,
    val getMessageDetail: ClientMessage?,
    val getMessageHistory: MessageHistoryVoPage,
    ...
    val pendingDeliveryOrders: Iterable<Order>,
    val product: Product?,
    val productDailySales: Iterable<ProductDailySales>,
    val productSalesTrend: ProductSalesTrend?,
    val productStatistics: ProductStatistics?,
    val productsByFavorites: ProductFavoriteVoPage,
    val productsPaginated: ProductVoPage?,
    ...
    val searchAllAddresses: Iterable<Address>,
    val searchMessages: MessageHistoryVoPage,
    val searchRegions: Iterable<Region>,
    val searchUserAddresses: Iterable<Address>,
    val suspiciousTransactions: Iterable<SuspiciousTransaction>,
    val todayStatistics: TodayStatistics?,
    ...
    val users: UserVoPage,
    val weekStatistics: WeekStatistics?,
...
data class RefundBucketDepositInput(
...
data class ReviewReconciliationInput(
    val reconciliationId: kotlin.Long,
    val reviewNotes: kotlin.String
) {
  constructor(args: Map<String, Any>) : this(
      args["reconciliationId"] as kotlin.Long,
      args["reviewNotes"] as kotlin.String
  )
}
...
data class SubmitDailyCollectionInput(
    val cashAmountCents: kotlin.Long,
    val collectionDate: kotlin.String? = null,
    val notes: kotlin.String? = null,
    val qrCodeAmountCents: kotlin.Long,
  ...
  constructor(args: Map<String, Any>) : this(
      args["cashAmountCents"] as kotlin.Long,
      args["collectionDate"] as kotlin.String?,
      args["notes"] as kotlin.String?,
      args["qrCodeAmountCents"] as kotlin.Long,
      args["waterTicketCount"] as kotlin.Int
  )
}
...
data class TodayStatistics(
    ...
    val totalOrders: kotlin.Int,
    val unfinishedOrders: kotlin.Int
)
...
data class UserFavoriteWithProductVoPage(
...
data class UserStatistics(
    ...
    val dailyNewUsers: Iterable<DailyStatistic>,
    val loginStatistics: LoginStatistics?,
    val monthNewUsers: kotlin.Int,
    val todayNewUsers: kotlin.Int,
...
data class UserSummaryVoPage(
    val list: Iterable<UserFavoriteSummary>,
    val pageInfo: PageInfo
)

data class UserVoPage(
...
data class WeekStatistics(
    val dailyStats: Iterable<DailyStat>,
    val totalEarning: kotlin.Long,
    val totalOrders: kotlin.Int
)
