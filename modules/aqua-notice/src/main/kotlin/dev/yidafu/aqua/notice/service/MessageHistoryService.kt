...
class MessageHistoryService(
    ...
    fun save(messageHistory: MessageHistory): MessageHistory {
        logger.debug("Saving message history for user ${messageHistory.userId}")
        return messageHistoryRepository.save(messageHistory)
    }

    fun findByUserId(userId: Long, pageable: Pageable): Page<MessageHistory> {
    ...
    fun updateSuccess(messageId: Long, wxMessageId: String) {
        logger.debug("Updating message $messageId as sent with wx_message_id: $wxMessageId")

        val message = messageHistoryRepository.findById(messageId)
    ...
    fun updateFailure(messageId: Long, errorMessage: String) {
    ...
    fun findFailedMessagesForRetry(): List<MessageHistory> {
    ...
    private fun updateStatistics(messageType: String, status: String) {
        try {
    ...
    fun findByWxMessageId(wxMessageId: String): MessageHistory? {
