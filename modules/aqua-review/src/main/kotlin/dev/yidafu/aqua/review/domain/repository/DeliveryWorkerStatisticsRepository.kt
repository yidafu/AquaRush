...
@Repository
interface DeliveryWorkerStatisticsRepository : JpaRepository<DeliveryWorkerStatisticsModel, Long>, DeliveryWorkerStatisticsRepositoryCustom {
  ...
  fun findByTotalReviewsGreaterThanEqual(
    minReviews: Int,
    pageable: Pageable,
